# Corrections implemented in MF-PRISM-MATH-2026-06 Version 2.2

- Migrated the identifier from `MF-MATH-2026-06` to `MF-PRISM-MATH-2026-06` while preserving the predecessor record.
...
- Made explicit that the cardinal-function range is taken over attained sums, equivalently positive generating-polynomial coefficients.
